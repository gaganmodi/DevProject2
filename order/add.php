<?php
  ...
  if(isset($_POST['done'])){
    ...
    $OrderStaffID = $_POST['staffID'];
    $q = "
      INSERT INTO PHPOrders (OrderProductID, OrderQuantity, OrderCost, OrderDate, OrderStaffID)
      VALUES ('$OrderProductID', '$OrderQuantity', '$OrderCost', '$OrderDate', '$OrderStaffID')
    ";
          ...
          <form method="post">
            <div class="modal-body">
              <div class="card-header bg-info">
                <h1 class="text-white text-center"> Add New Order </h1>
              </div>
              <br>
              ...
              <input type="Date" name="OrderDate" class="form-control"> <br>
              <label>Order Cost</label>
              <input type="number" name="OrderCost" class="form-control"> <br>
